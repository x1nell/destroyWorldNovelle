const storyParts = [{
	...
	text: "Почему я должен сидеть в этой стереотипной для людей клетке, во избежание опасности, которой не было уже много лет, быть может ничего и не существует на той стороне мира?- Подумал Кацуми",
	imageUrl: "img/1fon.png",
	nextPart: 8
}, {
	text: "В чём же причина?",
	imageUrl: "img/1fon.png",
	nextPart: 9
}, ];
